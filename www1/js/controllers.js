angular.module('starter.controllers', ['ionic', 'ngCordova', 'ionic-timepicker', 'ion-datetime-picker', 'ionic.rating'])
    ...
    .controller('ServiceTypeCtrl', function ($scope, $state, $stateParams,BlueTeam,TimeBoard) {
    ...
    .controller('FinishCtrl', function ($scope, $state, $window, $ionicHistory, $timeout, $stateParams, $ionicLoading, $timeout,
                                        $localstorage, $cordovaDevice, BlueTeam,TimeBoard) {
    ...
    .controller('F&QCtrl', function ($scope, $state, $ionicLoading, $ionicHistory, $timeout, $stateParams, BlueTeam,TimeBoard) {
    ...
    .controller('ContactUsCtrl', function ($scope, $state, $ionicHistory, $timeout, $stateParams, BlueTeam,TimeBoard) {
    ...
    .controller('BookCtrl', function ($scope, $state, $ionicLoading, $timeout, $ionicHistory, $stateParams,
                                      $cordovaGeolocation, $localstorage, $cordovaDevice, BlueTeam,TimeBoard) {
        //for datetime picker
